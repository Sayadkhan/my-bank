...
btnTransfer.addEventListener("click", function (e) {
  ...
  if (
    ...
    updateUI(currentAccount);
    // show message
    labelWelcome.textContent = `transaticon succesful`;
  } else {
    labelWelcome.textContent = `transaticon faild`;
  }
});
...
btnLoan.addEventListener("click", function (e) {
  ...
  if (
    ...
    //add positive movemet into curent account
    currentAccount.movements.push(amount);
    //updateui
    updateUI(currentAccount);
    // message
    ...
    labelWelcome.textContent = "you are not able for loan";
  }
